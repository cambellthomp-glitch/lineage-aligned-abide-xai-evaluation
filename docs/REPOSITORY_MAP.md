...
- `src/`: analysis, model, lineage, sanity, and repeated-removal code plus the configuration files required for import inspection.
- `scripts/figures/`: figure-generation code copied and path-sanitized from the audited exhibit workflows.
- `configs/`: frozen analysis configuration copies.
